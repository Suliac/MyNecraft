...
class YRenderer 
{
	...
	public :
		...
		*/
		...
		void sendElapsedToShader(int prog, float elapsed)
		{

			checkGlError("start sendElapsedToShader");
			...
			int var = glGetUniformLocation(prog, "elapsed");
			glUniform1f(var, (float)(elapsed));

			checkGlError("Fin sendElapsedToShader");
		}
